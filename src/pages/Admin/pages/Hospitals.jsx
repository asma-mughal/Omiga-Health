...
const Hospitals = () => {
  ...
  const { addHospital,editHospital,
    deleteHospital,
    retrieveHospital,hospitalAdded, setHospitalAdded,addDepartment ,hospitalData,
...
const [hospitalId, setHospitalId] = useState(null);
  ...
  const handleAddFormSubmit = (event) => {
    ...
    setTimeout(()=>{
      ...
      console.log("kindly add dept here")
  ...
  const handleEditClick = (event, contact) => {
    ...
    setSelectedImages((previousImages) => previousImages.concat(formValues.image));
  };
 ...
 <form onSubmit={handleAddFormSubmit}>
        <input
          ...
          border-gray-300 px-2 py-2 text-gray-900 placeholder-gray-500 
          sm:text-sm "
          required="required"
